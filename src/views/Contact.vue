<template>
    <section class="relative z-10 overflow-hidden bg-white py-20">
        <div class="container mx-auto">
            <div class="px-6 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <p class="text-body-color mb-9 text-base leading-relaxed">
                            Our platform harnesses the power of advanced technology to provide you with real-time updates on
                            stock prices and trading volumes. We source data from reputable exchanges and financial
                            institutions to ensure accuracy and reliability.
                        </p>
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">(+91) 8081198814</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">prashantsingh5aug@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                        <form ref="form" @submit.prevent="submitForm">
                            ...
                            <div>
                                <button type="submit"
                                    class="bg-blue-700 text-lg border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90">
                                    <v-icon v-if="loader" name="ri-loader-line" class="text-white mx-4" animation="spin"
                                        speed="slow" />
...
export default {
    ...
    data() {
        return {
            formValues: { name: "", phone: "", message: "", email: "" },
            loader: false
        }
    }
}
